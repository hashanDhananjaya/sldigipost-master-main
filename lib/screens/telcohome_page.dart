...
class TelcoHomePage extends StatefulWidget {
  ...
  @override
  _TelcoHomePageState createState() => _TelcoHomePageState();
}

class _TelcoHomePageState extends State<TelcoHomePage> {
                    ...
                    Align(
                      ...
                      child: Material(
                        ...
                        child: Container(
                          ...
                          child: InkWell(
                            onTap: () {
                              // Navigator.pushNamed(context,'/dialogpromotions');
                              Navigator.push(context, PageTransition(type: PageTransitionType.rightToLeft, duration: Duration (seconds: 1), child: DialogPromotionsPage()));
                            },
                            child: Image.asset(
                    ...
                    Align(
                      ...
                      child: Material(
                        ...
                        child: Container(
                          ...
                          child: Image.asset(
                            'images/telcohomepics/sltmobitel.png',
                            width: 50,
                            height: 50,
                            fit: BoxFit.contain,
                          ),
                      ...
                      child: Material(
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Image.asset(
                              'images/telcohomepics/airtel.png',
                              width: 50,
                              height: 50,
                              fit: BoxFit.contain,
                            ),
                      ...
                      child: Material(
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Image.asset(
                              'images/telcohomepics/hutch.png',
                              width: 50,
                              height: 50,
                              fit: BoxFit.contain,
                            ),
                      ...
                      child: Material(
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            EdgeInsetsDirectional.fromSTEB(0, 10, 0, 10),
                            child: Image.asset(
                              'images/telcohomepics/lankabel.png',
                              width: 50,
                              height: 50,
                              fit: BoxFit.contain,
                            ),
